...
>
    ...
    >
        <div class="ps-3 pe-4">
            <x-artisanpack-icon name="o-chevron-down" class="hidden size-3! group-data-open/disclosure-button:block" />
            <x-artisanpack-icon name="o-chevron-right" class="block size-3! group-data-open/disclosure-button:hidden" />
        </div>
