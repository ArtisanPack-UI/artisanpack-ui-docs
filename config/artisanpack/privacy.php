...
return [
    ...
    */
    'routes' => [
        // The package's default web routes render Blade views (privacy policy,
        // verification, reconsent). This app is Inertia-only, so we disable
        // the package's route auto-registration and mount the JSON API +
        // non-view endpoints ourselves in routes/privacy.php.
        'enabled' => false,
        'prefix' => 'privacy',
        'middleware' => ['web'],
    ...
    */
    'admin' => [
        // We render the admin dashboard as Inertia pages under
        // /dashboard/privacy that mount the package's React admin
        // components, so its Blade admin routes are disabled.
        'enabled' => false,
