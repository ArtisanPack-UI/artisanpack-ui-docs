...
use Modules\Packages\Sitemap\ChangelogSitemapProvider;
use Modules\Packages\Sitemap\DocumentationSitemapProvider;
use Modules\Pages\Sitemap\PageSitemapProvider;
...
return [
    ...
    */
    ...
    'sitemap' => [
        ...
        /*
         * Route registration is handled by App\Http\Controllers\SitemapController
         * so the sitemap is a single urlset built from the configured providers.
         * The package's default index-plus-per-type controller relies on the
         * SitemapEntry table populated by the HasSeo observer, which we disable
         * (see Page::bootHasSeo).
         */
        'route_enabled' => false,
        ...
        'providers' => [
            'pages' => PageSitemapProvider::class,
            'documentation' => DocumentationSitemapProvider::class,
            'changelogs' => ChangelogSitemapProvider::class,
        ],
        'types' => [
            'standard' => true,
            'image' => false,
