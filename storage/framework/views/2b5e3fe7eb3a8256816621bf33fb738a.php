...
<?php endif; ?>
<?php $component->withAttributes(['wire:submit' => 'register','class' => 'flex flex-col gap-6']); ?>
        <!-- Name -->
...
<?php $component = ArtisanPack\LivewireUiComponents\View\Components\Input::resolve(['label' => __('Name')] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['wire:model' => 'name','type' => 'text','required' => true,'autofocus' => true,'autocomplete' => 'name','placeholder' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Full name'))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $attributes = $attributes->except(\ArtisanPack\LivewireUiComponents\View\Components\Input::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:model' => 'email','type' => 'email','required' => true,'autocomplete' => 'email','placeholder' => 'email@example.com']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal142bec0eb54e444be121573a52fe2b87)): ?>
<?php $attributes = $__attributesOriginal142bec0eb54e444be121573a52fe2b87; ?>
...
</div><?php /**PATH /Users/jacobmartella/Herd/artisanpack-ui-docs/resources/views/livewire/auth/register.blade.php ENDPATH**/ ?>